...
def proiz(*args):
=======
"Произведение аргументов, расположенных между первым и вторым нулевыми аргументами. Произведение вычислить функцией. Args дать переменную вместо индекса"

def f(*args):
>>>>>>> 462723623fcb248b96fc5348e3f2c13f7a811569
    p = 1
    for i in args:
        p *= i
    return p
